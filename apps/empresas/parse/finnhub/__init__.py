...
from apps.empresas.parse.finnhub.normalize_data import NormalizeFinnhub
...
class ParseFinhub:
    ...
    def _get(self, path, **kwargs):
        return self.base_request(path=path, dict_params=kwargs)
    ...
    def stock_symbols(self, exchange, mic=None, security_type=None, currency=None):
        return self._get("/stock/symbol",
                         params={"exchange": exchange, 'mic': mic, 'securityType': security_type,
                                 'currency': currency})
    ...
    def upgrade_downgrade(self, symbol=None, _from=None, to=None):
        return self._get("/stock/upgrade-downgrade",
    ...
    def etfs_holdings(self, symbol=None, isin=None, skip=None, date=None):
        return self._get("/etf/holdings",
                         params={"symbol": symbol, "isin": isin, "skip": skip, "date": date})
    ...
    def international_filings(self, symbol="", country=""):
        return self._get("/stock/international-filings",
                         params={"symbol": symbol, "country": country})
    ...
    def sec_similarity_index(self, symbol="", cik="", freq="annual"):
        return self._get("/stock/similarity-index",
                         params={"symbol": symbol, "cik": cik, "freq": freq})
    ...
    def mutual_fund_holdings(self, symbol=None, isin=None, skip=None):
        return self._get("/mutual-fund/holdings",
                         params={"symbol": symbol, "isin": isin, "skip": skip})
    ...
    def stock_visa_application(self, symbol, _from=None, to=None):
        return self._get("/stock/visa-application",
                         params={"symbol": symbol, "from": _from, "to": to})
