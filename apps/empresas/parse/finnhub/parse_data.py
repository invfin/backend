...
class ParseFinnhub(ParserClient):
    ...
    def aggregate_indicator(self, symbol, resolution):
        return self.request(path="scan", str_params="technical-indicator", dict_params={
            "symbol": symbol,
    ...
    def press_releases(self, symbol, _from=None, to=None):
        return self.request(path="press-releases", dict_params={
            "symbol": symbol,
            "from": _from,
            "to": to
        })
    ...
    def stock_dividends(self, symbol, _from=None, to=None):
        return self.request(path="stock", str_params="dividend", dict_params={
            "symbol": symbol,
            "from": _from,
            "to": to
        })
    ...
    def stock_symbols(self, exchange, mic=None, security_type=None, currency=None):
        return self.request(path="stock", str_params="symbol",
                         dict_params={"exchange": exchange, 'mic': mic, 'securityType': security_type,
                                 'currency': currency})
    ...
    def upgrade_downgrade(self, symbol=None, _from=None, to=None):
        return self.request(path="stock", str_params="upgrade-downgrade",
                         dict_params={'symbol': symbol, 'from': _from, 'to': to})
    ...
    def company_basic_financials(self, symbol, metric):
        return self.request(path="stock", str_params="metric", dict_params={
            "symbol": symbol,
            "metric": metric
        })

    def financials(self, symbol, statement, freq):
        return self.request(path="stock", str_params="financials", dict_params={
            "symbol": symbol,
            "statement": statement,
            "freq": freq
        })
    ...
    def fund_ownership(self, symbol, limit=None):
        return self.request(path="stock", str_params="fund-ownership", dict_params={
            "symbol": symbol,
            "limit": limit
        })

    def company_earnings(self, symbol, limit=None):
        return self.request(path="stock", str_params="earnings", dict_params={
            "symbol": symbol,
            "limit": limit
        })

    def company_revenue_estimates(self, symbol, freq=None):
        return self.request(path="stock", str_params="revenue-estimate", dict_params={
            "symbol": symbol,
            "freq": freq
        })

    def company_ebitda_estimates(self, symbol, freq=None):
        return self.request(path="stock", str_params="ebitda-estimate", dict_params={
            "symbol": symbol,
            "freq": freq
        })

    def company_ebit_estimates(self, symbol, freq=None):
        return self.request(path="stock", str_params="ebit-estimate", dict_params={
            "symbol": symbol,
            "freq": freq
        })

    def company_eps_estimates(self, symbol, freq=None):
        return self.request(path="stock", str_params="eps-estimate", dict_params={
            "symbol": symbol,
            "freq": freq
        })
    ...
    def quote(self, symbol):
        return self.request(path="quote", dict_params={
            "symbol": symbol
        })
    ...
    def forex_symbols(self, exchange):
        return self.request(path="forex", str_params="symbol", dict_params={
            "exchange": exchange
        })

    def forex_candles(self, symbol, resolution, _from, to, _format='json'):
        return self.request(path="forex", str_params="candle", dict_params={
            "symbol": symbol,
            "resolution": resolution,
            "from": _from,
            "to": to,
    ...
    def crypto_candles(self, symbol, resolution, _from, to, _format='json'):
        return self.request(path="crypto", str_params="candle", dict_params={
            "symbol": symbol,
            "resolution": resolution,
            "from": _from,
            "to": to,
    ...
    def pattern_recognition(self, symbol, resolution):
        return self.request(path="scan", str_params="pattern", dict_params={
            "symbol": symbol,
            "resolution": resolution
        })

    def support_resistance(self, symbol, resolution):
        return self.request(path="scan", str_params="support-resistance", dict_params={
            "symbol": symbol,
            "resolution": resolution
        })
    ...
    def stock_splits(self, symbol, _from, to):
        return self.request(path="stock", str_params="split", dict_params={
            "symbol": symbol,
            "from": _from,
            "to": to
        })
    ...
    def general_news(self, category, min_id=0):
        return self.request(path="news", dict_params={
            "category": category,
            "minId": min_id
        })

    def company_news(self, symbol, _from, to):
        return self.request(path="company-news", dict_params={
            "symbol": symbol,
            "from": _from,
            "to": to
        })
    ...
    def news_sentiment(self, symbol):
        return self.request(path="news-sentiment", dict_params={
            "symbol": symbol
        })

    def ownership(self, symbol, limit=None):
        return self.request(path="stock", str_params="ownership", dict_params={
            "symbol": symbol,
            "limit": limit
        })
    ...
    def calendar_economic(self, _from=None, to=None):
        return self.request(path="calendar", str_params="economic", dict_params={
            "from": _from,
            "to": to
        })

    def earnings_calendar(self, _from, to, symbol, international=False):
        return self.request(path="calendar", str_params="earnings", dict_params={
            "from": _from,
            "to": to,
            "symbol": symbol,
    ...
    def ipo_calendar(self, _from, to):
        return self.request(path="calendar", str_params="ipo", dict_params={
            "from": _from,
            "to": to
        })
    ...
    def etfs_holdings(self, symbol=None, isin=None, skip=None, date=None):
        return self.request(path="etf", str_params="holdings",
                         dict_params={"symbol": symbol, "isin": isin, "skip": skip, "date": date})
    ...
    def international_filings(self, symbol="", country=""):
        return self.request(path="stock", str_params="international-filings",
                         dict_params={"symbol": symbol, "country": country})
    ...
    def sec_similarity_index(self, symbol="", cik="", freq="annual"):
        return self.request(path="stock", str_params="similarity-index",
                         dict_params={"symbol": symbol, "cik": cik, "freq": freq})
    ...
    def stock_insider_transactions(self, symbol, _from=None, to=None):
        return self.request(path="stock", str_params="insider-transactions",
                         dict_params={"symbol": symbol, "from": _from, "to": to})
    ...
    def mutual_fund_holdings(self, symbol=None, isin=None, skip=None):
        return self.request(path="mutual-fund", str_params="holdings",
                         dict_params={"symbol": symbol, "isin": isin, "skip": skip})
    ...
    def stock_social_sentiment(self, symbol, _from=None, to=None):
        return self.request(path="stock", str_params="social-sentiment",
                         dict_params={"symbol": symbol, "from": _from, "to": to})
    ...
    def company_earnings_quality_score(self, symbol, freq):
        return self.request(path="stock", str_params="earnings-quality-score", dict_params={"symbol": symbol, 'freq': freq})
    ...
    def stock_uspto_patent(self, symbol, _from=None, to=None):
        return self.request(path="stock", str_params="uspto-patent", dict_params={"symbol": symbol, "from": _from, "to": to})

    def stock_visa_application(self, symbol, _from=None, to=None):
        return self.request(path="stock", str_params="visa-application",
                         dict_params={"symbol": symbol, "from": _from, "to": to})

    def stock_insider_sentiment(self, symbol, _from, to):
        return self.request(path="stock", str_params="insider-sentiment",
                         dict_params={"symbol": symbol, "from": _from, "to": to})

    def stock_lobbying(self, symbol, _from, to):
        return self.request(path="stock", str_params="lobbying", dict_params={"symbol": symbol, "from": _from, "to": to})
    ...
    def stock_usa_spending(self, symbol, _from, to):
        return self.request(path="stock", str_params="usa-spending", dict_params={"symbol": symbol, "from": _from, "to": to})
