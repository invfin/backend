    ...
    def normalize_balance_sheets_yahooquery(
        ...
        return dict(
            **self.initial_data(
            ...
            cash_cash_equivalents_and_short_term_investments=yahooquery_serie.get("CashCashEquivalentsAndShortTermInvestments"),
            ...
            gains_losses_not_affecting_retained_earnings=yahooquery_serie.get("GainsLossesNotAffectingRetainedEarnings"),
            ...
            total_non_current_liabilities_net_minority_interest=yahooquery_serie.get("TotalNonCurrentLiabilitiesNetMinorityInterest"),
    ...
    def normalize_cashflow_statements_yahooquery(
        ...
        return dict(
            **self.initial_data(
            ...
            cash_flow_from_continuing_financing_activities=yahooquery_serie.get("CashFlowFromContinuingFinancingActivities"),
            cash_flow_from_continuing_investing_activities=yahooquery_serie.get("CashFlowFromContinuingInvestingActivities"),
            cash_flow_from_continuing_operating_activities=yahooquery_serie.get("CashFlowFromContinuingOperatingActivities"),
    ...
    def normalize_income_statements_yahooquery(
        ...
        return dict(
            **self.initial_data(
            ...
            net_income_from_continuing_and_discontinued_operation=yahooquery_serie.get("NetIncomeFromContinuingAndDiscontinuedOperation"),
            net_income_from_continuing_operation_net_minority_interest=yahooquery_serie.get("NetIncomeFromContinuingOperationNetMinorityInterest"),
            net_income_including_noncontrolling_interests=yahooquery_serie.get("NetIncomeIncludingNoncontrollingInterests"),
