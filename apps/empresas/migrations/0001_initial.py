...
import apps.empresas.extensions.company
import apps.empresas.extensions.finprep
import apps.empresas.extensions.y_finance
import apps.empresas.extensions.yahoo_query
import apps.empresas.models.company
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('checkings', models.JSONField(default=apps.empresas.models.company.default_dict)),
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.company.CompanyExtended),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.y_finance.IncomeStatementYFinanceExtended),
        ),
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.yahoo_query.IncomeStatementYahooQueryExtended),
        ),
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.finprep.IncomeStatementFinprepExtended),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_source', models.CharField(choices=[('finprep', 'Finprep'), ('finnhub', 'Finnhub'), ('y_finance', 'YFinance'), ('yahooquery', 'Yahooquery'), ('yahoo_finance', 'Yahoo Finance')], default='finprep', max_length=100)),
                ('country', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='countries.country')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data_source', models.CharField(choices=[('finprep', 'Finprep'), ('finnhub', 'Finnhub'), ('y_finance', 'YFinance'), ('yahooquery', 'Yahooquery'), ('yahoo_finance', 'Yahoo Finance')], default='y_finance', max_length=100)),
        ...
        migrations.AddField(
            model_name='company',
            name='industry',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='industries_sectors.industry'),
        ),
        migrations.AddField(
            model_name='company',
            name='sector',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='industries_sectors.sector'),
        ),
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.y_finance.CashflowStatementYFinanceExtended),
        ),
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.yahoo_query.CashflowStatementYahooQueryExtended),
        ),
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.finprep.CashflowStatementFinprepExtended),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.y_finance.BalanceSheetYFinanceExtended),
        ),
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.yahoo_query.BalanceSheetYahooQueryExtended),
        ),
        migrations.CreateModel(
            ...
            bases=(models.Model, apps.general.mixins.BaseToAllMixin, apps.empresas.extensions.finprep.BalanceSheetFinprepExtended),
        ),
        migrations.CreateModel(
            name='BalanceSheet',
            fields=[
