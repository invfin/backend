    ...
    def test_create_income_statements_finprep(self):
        ...
        for statement in previous_list_data:
            ...
            with self.subTest(statement):
                ...
                assert(statement.general_and_administrative_expenses == new_statement.general_and_administrative_expenses)
                ...
                assert(statement.selling_general_and_administrative_expenses == new_statement.selling_general_and_administrative_expenses)
    ...
    def test_create_balance_sheets_finprep(self):
        ...
        for statement in previous_list_data:
            ...
            with self.subTest(statement):
                ...
                assert(statement.accumulated_other_comprehensive_income_loss == new_statement.accumulated_other_comprehensive_income_loss)
                ...
                assert(statement.deferred_tax_liabilities_non_current == new_statement.deferred_tax_liabilities_non_current)
                ...
                assert(statement.total_liabilities_and_stockholders_equity == new_statement.total_liabilities_and_stockholders_equity)
    ...
    def test_create_cashflow_statements_finprep(self):
        ...
        for statement in previous_list_data:
            ...
            with self.subTest(statement):
                ...
                assert(statement.inventory == new_statement.inventory)
                assert(statement.investments_in_property_plant_and_equipment == new_statement.investments_in_property_plant_and_equipment)
                assert(statement.net_cash_provided_by_operating_activities == new_statement.net_cash_provided_by_operating_activities)
                assert(statement.net_cash_used_for_investing_activites == new_statement.net_cash_used_for_investing_activites)
                assert(statement.net_cash_used_provided_by_financing_activities == new_statement.net_cash_used_provided_by_financing_activities)
