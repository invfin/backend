    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('risk_profile', models.CharField(blank=True, choices=[('very-agressive', 'Perfil muy agresivo'), ('agressive', 'Perfil agresivo'), ('regular', 'Perfil regular'), ('conservative', 'Perfil conservador'), ('very-conservative', 'Perfil muy conservador')], max_length=500)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sector_knowledge', models.CharField(blank=True, choices=[('expert', 'Experto'), ('pro', 'Profesional'), ('intermediate', 'Intermedio'), ('basic', 'Básico'), ('null', 'Nulo')], default=('null', 'Nulo'), max_length=500, null=True)),
                ('asset_knowledge', models.CharField(blank=True, choices=[('expert', 'Experto'), ('pro', 'Profesional'), ('intermediate', 'Intermedio'), ('basic', 'Básico'), ('null', 'Nulo')], default=('null', 'Nulo'), max_length=500, null=True)),
                ...
                ('result', models.IntegerField(blank=True, choices=[(1, 'Comprar'), (2, 'Vender'), (3, 'Mantener'), (4, 'Error')], null=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('objectif', models.IntegerField(blank=True, choices=[(1, 'Generar ingresos pasivos'), (2, 'Generar un patrimonio'), (3, 'Ahorrar'), (4, 'Ganar dinero rápido')], default=1, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('finished', 'Finished'), ('abandoned', 'Abandoned'), ('started', 'Started'), ('not-payed', 'Not payed')], default='started', max_length=500)),
            ],
            options={
