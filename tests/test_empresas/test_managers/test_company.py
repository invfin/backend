...
class TestManager(TestCase):
    ...
    def setUpTestData(cls):
        ...
        cls.exchange_org_usa = DjangoTestingModel.create(
            ExchangeOrganisation, name="Estados Unidos"
        )
        cls.exchange_nyse = DjangoTestingModel.create(
            Exchange, exchange_ticker="NYSE", main_org=cls.exchange_org_usa
        )
        cls.exchange_euro = DjangoTestingModel.create(
            Exchange, exchange_ticker="EURO", main_org=cls.exchange_org_fr
        )
    ...
    def test_filter_checking(self):
        ...
        companies_no_institutionals = list(
            Company.objects.filter_checking("institutionals", False)
        )
