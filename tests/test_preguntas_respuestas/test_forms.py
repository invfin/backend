...
class TestCreateQuestionForm(TestCase):
    ...
    def test_clean_title(self):
        ...
        assert form.is_valid() is False
        assert (
            "Formula tu pregunta para que la comunidad pueda ayudarte" in form.errors["title"]
        ) is True
