...
class TestMixins(TestCase):
    def test_save_unique_field(self):
        term = DjangoTestingModel.create(Term, slug="nada")
        ...
        term_2 = DjangoTestingModel.create(Term, slug="nada-raro")
...
class TestBaseToAllMixin(TestCase):
    ...
    def setUpTestData(cls) -> None:
        cls.term = DjangoTestingModel.create(Term, id=1, slug="nada")
