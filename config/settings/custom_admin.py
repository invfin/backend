...
SIDE_MENU = [
    ...
    },
    {
        ...
        "models": (
            ...
            {"model": "seo.UserTermVisited", "label": "Term visited"},
        ),
    },
    {
        "label": "Visiteurs",
        ...
        "models": (
            ...
            {"model": "seo.VisiteurCompanyVisited", "label": "Company visited"},
            {"model": "seo.VisiteurPublicBlogVisited", "label": "Blog visited"},
            {"model": "seo.VisiteurQuestionVisited", "label": "Question visited"},
            {"model": "seo.VisiteurTermVisited", "label": "Term visited"},
        ),
    },
    {
        "label": "General",
    ...
    },
    {
        ...
        "models": (
            ...
            {"model": "cartera.Spendings"},
            {"model": "cartera.Savings"},
            {"model": "cartera.NetWorth"},
            {"model": "currencies.UserDefaultCurrency"},
        ),
    },
    {
        "label": "Socialmedia",
...
NAVBAR_COLOR = COLOR_WARNING
if IS_PROD:
    NAVBAR_COLOR = COLOR_DANGER
JAZZMIN_UI_TWEAKS = {
    "navbar": f"navbar-white navbar-light progress-bar-striped bg-{NAVBAR_COLOR}",
