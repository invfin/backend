...
class RoboAdvisorUserServiceActivity(Model):
    ...
    def temp_profile_related(self):
        if (
            self.service.slug == "investor-profile"
            and TemporaryInvestorProfile.objects.filter(service_activity=self).exists()
        ):
            return True
        return False
    ...
    def service_result(self):
        ...
        return {"title": title, "result": result, "explanation": explanation, "extra": extra}
    ...
    def metadata(self):
        ...
        metadata = {"title": title, "thumbnail": thumbnail}
        return metadata
...
class RoboAdvisorQuestionInvestorExperience(BaseRoboAdvisorQuestion):
    ...
    investor_type_self_definition = CharField(
        max_length=500, null=True, blank=True, choices=INVESTOR_TYPE, default=INVESTOR_TYPE[1]
    )
    percentage_invested = DecimalField(
        blank=True,
        default=0,
        max_digits=10,
        decimal_places=2,
...
class RoboAdvisorQuestionPortfolioAssetsWeight(BaseRoboAdvisorQuestion):
    ...
    stocks_percentage = DecimalField(
        blank=True,
        default=0,
        max_digits=10,
        decimal_places=2,
    ...
    real_estate_percentage = DecimalField(
        blank=True,
        default=0,
        max_digits=10,
        decimal_places=2,
    ...
    sofipos_percentage = DecimalField(
        blank=True,
        default=0,
        max_digits=10,
        decimal_places=2,
    ...
    cryptos_percentage = DecimalField(
        blank=True,
        default=0,
        max_digits=10,
        decimal_places=2,
