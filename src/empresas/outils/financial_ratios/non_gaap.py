...
class NonGaap:
    ...
    def calculate_normalized_income(
        ...
        return net_income - total_other_income_expenses_net
    ...
    def calculate_average_accounts_payable(
        ...
        return round((last_year_accounts_payable + accounts_payable) / 2, 2)
    ...
    def calculate_tangible_assets(
        ...
        return total_current_assets + property_plant_equipment_net
