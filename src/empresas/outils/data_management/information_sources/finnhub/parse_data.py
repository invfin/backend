...
class ParseFinnhub(ParserClient):
    ...
    def press_releases(self, symbol, _from=None, to=None):
        return self.request(
            path="press-releases", dict_params={"symbol": symbol, "from": _from, "to": to}
        )

    def company_executive(self, symbol):
        return self.request(
            path="stock", str_params="executive", dict_params={"symbol": symbol}
        )
    ...
    def stock_basic_dividends(self, symbol):
        return self.request(
            path="stock", str_params="dividend2", dict_params={"symbol": symbol}
        )
    ...
    def recommendation_trends(self, symbol):
        return self.request(
            path="stock", str_params="recommendation", dict_params={"symbol": symbol}
        )

    def price_target(self, symbol):
        return self.request(
            path="stock", str_params="price-target", dict_params={"symbol": symbol}
        )

    def upgrade_downgrade(self, symbol=None, _from=None, to=None):
        return self.request(
            path="stock",
            str_params="upgrade-downgrade",
            dict_params={"symbol": symbol, "from": _from, "to": to},
        )
    ...
    def company_basic_financials(self, symbol, metric):
        return self.request(
            path="stock", str_params="metric", dict_params={"symbol": symbol, "metric": metric}
        )

    def financials(self, symbol, statement, freq):
        return self.request(
            path="stock",
            str_params="financials",
            dict_params={"symbol": symbol, "statement": statement, "freq": freq},
        )

    def financials_reported(self, **dict_params):
        return self.request(
            path="stock", str_params="financials-reported", dict_params=dict_params
        )

    def fund_ownership(self, symbol, limit=None):
        return self.request(
            path="stock",
            str_params="fund-ownership",
            dict_params={"symbol": symbol, "limit": limit},
        )

    def company_earnings(self, symbol, limit=None):
        return self.request(
            path="stock", str_params="earnings", dict_params={"symbol": symbol, "limit": limit}
        )

    def company_revenue_estimates(self, symbol, freq=None):
        return self.request(
            path="stock",
            str_params="revenue-estimate",
            dict_params={"symbol": symbol, "freq": freq},
        )

    def company_ebitda_estimates(self, symbol, freq=None):
        return self.request(
            path="stock",
            str_params="ebitda-estimate",
            dict_params={"symbol": symbol, "freq": freq},
        )
    ...
    def transcripts_list(self, symbol):
        return self.request(
            path="stock", str_params="transcripts/list", dict_params={"symbol": symbol}
        )

    def sim_index(self, **dict_params):
        return self.request(
            path="stock", str_params="similarity-index", dict_params=dict_params
        )
    ...
    def forex_symbols(self, exchange):
        return self.request(
            path="forex", str_params="symbol", dict_params={"exchange": exchange}
        )
    ...
    def crypto_symbols(self, exchange):
        return self.request(
            path="crypto", str_params="symbol", dict_params={"exchange": exchange}
        )
    ...
    def pattern_recognition(self, symbol, resolution):
        return self.request(
            path="scan",
            str_params="pattern",
            dict_params={"symbol": symbol, "resolution": resolution},
        )

    def support_resistance(self, symbol, resolution):
        return self.request(
            path="scan",
            str_params="support-resistance",
            dict_params={"symbol": symbol, "resolution": resolution},
        )
    ...
    def company_news(self, symbol, _from, to):
        return self.request(
            path="company-news", dict_params={"symbol": symbol, "from": _from, "to": to}
        )
    ...
    def calendar_economic(self, _from=None, to=None):
        return self.request(
            path="calendar", str_params="economic", dict_params={"from": _from, "to": to}
        )
    ...
    def ipo_calendar(self, _from, to):
        return self.request(
            path="calendar", str_params="ipo", dict_params={"from": _from, "to": to}
        )
    ...
    def indices_hist_const(self, **dict_params):
        return self.request(
            path="index", str_params="historical-constituents", dict_params=dict_params
        )

    def etfs_profile(self, symbol=None, isin=None):
        return self.request(
            path="etf", str_params="profile", dict_params={"symbol": symbol, "isin": isin}
        )
    ...
    def international_filings(self, symbol="", country=""):
        return self.request(
            path="stock",
            str_params="international-filings",
    ...
    def sec_sentiment_analysis(self, access_number):
        return self.request(
            path="stock",
            str_params="filings-sentiment",
            dict_params={"accessNumber": access_number},
        )

    def sec_similarity_index(self, symbol="", cik="", freq="annual"):
        return self.request(
            path="stock",
            str_params="similarity-index",
    ...
    def stock_insider_transactions(self, symbol, _from=None, to=None):
        return self.request(
            path="stock",
            str_params="insider-transactions",
            dict_params={"symbol": symbol, "from": _from, "to": to},
        )
    ...
    def mutual_fund_profile(self, symbol=None, isin=None):
        return self.request(
            path="mutual-fund",
            str_params="profile",
            dict_params={"symbol": symbol, "isin": isin},
        )
    ...
    def mutual_fund_sector_exp(self, symbol):
        return self.request(
            path="mutual-fund", str_params="sector", dict_params={"symbol": symbol}
        )

    def mutual_fund_country_exp(self, symbol):
        return self.request(
            path="mutual-fund", str_params="country", dict_params={"symbol": symbol}
        )

    def stock_revenue_breakdown(self, symbol, cik=""):
        return self.request(
            path="stock",
            str_params="revenue-breakdown",
            dict_params={"symbol": symbol, "cik": cik},
        )

    def stock_social_sentiment(self, symbol, _from=None, to=None):
        return self.request(
            path="stock",
            str_params="social-sentiment",
            dict_params={"symbol": symbol, "from": _from, "to": to},
        )

    def stock_investment_theme(self, theme):
        return self.request(
            path="stock", str_params="investment-theme", dict_params={"theme": theme}
        )

    def stock_supply_chain(self, symbol):
        return self.request(
            path="stock", str_params="supply-chain", dict_params={"symbol": symbol}
        )
    ...
    def company_earnings_quality_score(self, symbol, freq):
        return self.request(
            path="stock",
            str_params="earnings-quality-score",
            dict_params={"symbol": symbol, "freq": freq},
        )

    def crypto_profile(self, symbol):
        return self.request(
            path="crypto", str_params="profile", dict_params={"symbol": symbol}
        )

    def stock_uspto_patent(self, symbol, _from=None, to=None):
        return self.request(
            path="stock",
            str_params="uspto-patent",
            dict_params={"symbol": symbol, "from": _from, "to": to},
        )
    ...
    def bond_price(self, isin, _from, to):
        return self.request(
            path="bond",
            str_params="price",
            dict_params={"isin": isin, "from": _from, "to": to},
        )

    def stock_usa_spending(self, symbol, _from, to):
        return self.request(
            path="stock",
            str_params="usa-spending",
            dict_params={"symbol": symbol, "from": _from, "to": to},
        )
