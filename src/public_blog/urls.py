...
subdomains_urls = [
    ...
    path(
        "create-newsletter-blog/<slug>/",
        create_newsletter_for_blog,
        name="create_newsletter_blog",
    ),
    path(
        "update-newsletter-blog/<pk>/",
        UpdateBlogNewsletterView.as_view(),
        name="update_newsletter_blog",
    ),
...
urlpatterns = [
    ...
    path(
        "start-following-writer/", following_management_view, name="following_management_view"
    ),
] + subdomains_urls
