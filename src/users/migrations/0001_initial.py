...
import src.users.user_extension
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ("notifications", models.JSONField(default=src.users.models.default_dict)),
                (
                    "groups",
            ...
            bases=(models.Model, src.users.user_extension.UserExtended),
            managers=[
                ("objects", src.users.managers.UserExtraManager()),
            ],
        ),
        migrations.CreateModel(
            name="MetaProfile",
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    ...
                    django_countries.fields.CountryField(
                        blank=True, max_length=2, null=True, verbose_name="País de origen"
                    ),
                ),
                ...
                (
                    "foto_perfil",
                    models.ImageField(
                        default="inversorinteligente.WebP", upload_to="avatar/", verbose_name="Foto de perfil"
                    ),
                ),
            ...
            bases=(models.Model, src.general.mixins.BaseToAllMixin, src.general.mixins.ResizeImageMixin),
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "meta_info",
                    models.ForeignKey(
                        blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to="users.metaprofile"
                    ),
                ),
                (
                    "user",
            ...
            fields=[
                ...
                (
                    ...
                    models.ForeignKey(
                        null=True,
                        on_delete=django.db.models.deletion.SET_NULL,
                        related_name="credits_historial",
                        to=settings.AUTH_USER_MODEL,
                    ),
                ),
            ],
