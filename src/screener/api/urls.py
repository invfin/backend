...
urlpatterns = [
    path(
        "user-search-company/",
        suggest_list_search_companies,
        name="suggest_list_search_companies",
    ),
    path("valuations-list/", CompanyScreenerView.as_view(), name="valuation_list"),
    ...
    path(
        "retreive-company-valuation/<ticker>/",
        get_company_valuation,
        name="get_company_valuation",
    ),
    path(
        "add-observation/",
        CompanyObservationFormView.as_view(),
        name="create_company_observation",
    ),
    ...
    path(
        "retreive-yahoo-lists/<query>/",
        retreive_yahoo_screener_info,
        name="retreive_yahoo_screener_info",
    ),
    path(
        "return-similar-companies-screener/<sector_id>/<industry_id>/",
        return_similar_companies_screener,
        name="return_similar_companies_screener",
    ),
]
