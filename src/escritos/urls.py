...
urlpatterns = [
    ...
    path(
        "users-corrections-to-review/",
        ManageUserTermCorrectionListView.as_view(),
        name="manage_all_corrections",
    ),
    path(
        "correction-to-review/<pk>/",
        ManageUserTermCorrectionDetailView.as_view(),
        name="manage_user_correction",
    ),
]
